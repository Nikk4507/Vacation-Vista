...
def View():
    ...
    def First():  
        ...
        chat_1 = Label(b,text="CAFE",bg='black',fg='red')
    ...
    btn2 = Button(root,text="click",command=NONE)
    btn2.place(relx=0.81,rely=0.48, relwidth=0.02,relheight=0.02)

    btn3 = Button(root,text="click",command=NONE)
    btn3.place(relx=0.73,rely=0.53, relwidth=0.02,relheight=0.02)

    btn4 = Button(root,text="click",command=NONE)
